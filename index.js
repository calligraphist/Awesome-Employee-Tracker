  ...
  function updateEmployee() {
    inquirer
      ...
      .then(function(answer) {
        ...
        connection.query('UPDATE employee SET role_id=? WHERE first_name= ?',[answer.updateRole, answer.Name],function(err, res) {
          if (err) throw err;
          console.table(res);
          init();
        });
  ...
  inquirer
    .prompt([
      ...
      },
      {
        type: "input",
        name: "dID",
        message: "Which department this role belongs to? please enter the id number?"
      }
    ])
    .then(function(answer) {
